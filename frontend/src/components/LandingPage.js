  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      >
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl font-bold text-gray-300 mb-12 leading-relaxed">
            ...
            <span className="text-thunder-yellow"> ropa exclusiva</span>.
            <br />
      ...
      <section 
        id="watches" 
        data-animate
        className={`py-20 px-4 bg-gray-950 transition-all duration-1000 delay-200 ${
          isVisible.watches ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
      >
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              <Watch className="w-12 h-12 text-thunder-yellow" />
      ...
      >
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 font-semibold">
              Zapatillas exclusivas y ropa streetwear
            </p>
          </div>
      ...
      >
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-5xl md:text-7xl font-black mb-8 leading-tight">
            ...
            <br />
            <span className="text-thunder-red">MEJORAR?</span>
          </h2>
          ...
          <p className="text-lg text-gray-400 font-semibold">
            Sin spam, solo ofertas increíbles • Gratis unirse
          </p>
        </div>
      </section>
