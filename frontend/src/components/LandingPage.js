              ...
              watchProducts.map((product, index) => (
                ...
                >
                  <div className="relative overflow-hidden">
                                         {/* Watch image */}
                     <div className="w-full h-48 md:h-64 bg-gray-800 border-2 border-thunder-yellow flex items-center justify-center">
                       {product.image ? (
                         <img 
                           src={product.image} 
                           alt={product.name}
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <div className="text-center text-gray-400">
                            ...
                            <p className="text-xs md:text-sm">Sin imagen</p>
                          </div>
                        </div>
                      )}
                    </div>
            ...
            {loading ? (
              ...
              otherProducts.map((product, index) => (
                ...
                >
                  <div className="relative overflow-hidden">
                                         {/* Product image */}
                     <div className="w-full h-48 md:h-64 bg-gray-800 border-2 border-gray-600 flex items-center justify-center">
                       {product.image ? (
                         <img 
                           src={product.image} 
                           alt={product.name}
              ...
              testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="relative">
                                         {/* Testimonial image */}
                     <div className="w-full h-64 bg-gray-800 border-2 border-gray-600 flex items-center justify-center">
                       {testimonial.review_image ? (
                         <img 
                           src={testimonial.review_image} 
                           alt={`Reseña de ${testimonial.name}`}
                           className="max-w-full max-h-full object-contain"
                         />
                      ) : (
                        <div className="w-full h-full flex items-center justify-center">
